  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="text-center mb-8">
        ...
        <a href="https://solana.com/zh/developers/guides/advanced/lookup-tables#how-to-use-an-address-lookup-table-in-a-transaction" target="_blank" className="underline text-blue-600">Develop docs</a>
      </div>
